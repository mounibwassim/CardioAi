  ...
  if (!e2) {
    ...
    e2 = r2 ? (t3, e3) => r2(t3, e3, n2) : (t3, e3) => {
      for (; Kn(e3) && 4 != e3.h; ) {
        ...
        o2 && o2(e3, t3, r3) || (r3 = (i2 = e3).l, Yn(i2), i2.ja ? i2 = void 0 : (s2 = i2.g.g - r3, i2.g.g = r3, i2 = Wn(i2.g, s2)), r3 = t3, i2 && (mt ||= /* @__PURE__ */ Symbol(), (s2 = r3[mt]) ? s2.push(i2) : r3[mt] = [i2])), a2 && o2 && !h2 && Wr++ < 5 && j();
      }
    }, t2[Ar] = e2;
  }
  return e2;
...
//# sourceMappingURL=vision_bundle-IJJXWL6H.js.map
